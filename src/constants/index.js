...
export const myProjects = [
  {
    ...
    subdesc:
      "Built with Next.js 15, LangChain, LangGraph, and Convex for advanced AI capabilities and performance.",
  ...
  },
  {
    ...
    title: "HiLink - One Stop Camping Destination",
    desc: "HiLink is a powerful service app that makes life of a camper a lot exciting. It provides all services of a camping that a camper ever needs, It supports millions of businesses simultaneously, ensuring that we surve best experience for any camping tourist",
    subdesc:
      "With HiLink, users can experience the best of camping, where a camper can have 3 tiers of subscription, and can avail multiple services accordingly",
  ...
  },
  {
    ...
    title: "CarePulse - Health Management System", // From original project 2
    desc: "An innovative healthcare platform designed to streamline essential medical processes. It simplifies patient registration, appointment scheduling, and medical record management, providing a seamless experience for both healthcare providers and patients.", // From original project 2
    subdesc:
      "With a focus on efficiency, CarePulse integrantes complex forms and SMS notifications, by using Next.js, Appwrite, Twillio and Sentry that enhance operational workflows.", // From original project 2
  ...
  },
  {
    ...
    title: "PDFQuery - PDF to Quiz/Summary App", // From original project 3
    desc: "Built PDFQuery, an app that processes PDFs to generate 5-question quizzes for self-assessment or provides AI-generated summaries.", // From original project 3
    subdesc:
      "Processes PDFs to create quizzes or summaries, enhancing self-assessment and information extraction.", // From original project 3
  ...
  },
  {
    ...
    subdesc:
      "An e-commerce platform using React JS and Appwrite for delivering fresh vegetables, featuring real-time order and review management.",
